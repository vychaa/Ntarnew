...
const Footer = () => {
  return (
    <div style={{ overflowX: "hidden" }} className="container-footer">
          ...
          <div className="row">
            ...
            <div className="col-12 col-lg-12 mb-4 footer-text-title">
              <span
                ...
                className="footer-main-text footer-main-text_mob"
              >
                <span
                  className="footer-main-text footer-main-text_mob"
                  style={{ color: "#F9E400" }}
            ...
            <div className="cards-container">
              ...
              <div className="cards-container-sub">
                ...
                <div className="category">
                  ...
                  <div className="subcategories">
                    <div className="subcategory-container">
                      <a href="/Aboutus" className="subcategory">
                        Why NTAR
                      </a>
                      <p className="ptag"></p>
                      <a href="/Aboutus" className="subcategory">
              ...
              <div className="cards-container-sub web_subcard">
                <div className="category-2">
                  <p
                    style={{ textWrap: "nowrap", color: "#c2c2c2" }}
                  ...
                  <div className="subcategories">
                    <div className="subcategory-container">
                      <a href="/ContactPage" className="subcategory">
                        Contact Us
                      </a>
                      <p className="ptag"></p>
                      <a href="/ContactPage" className="subcategory">
                ...
                <div className="category-4">
                  ...
                  <div className="subcategories">
                    <div className="subcategory-container">
                      <a href="/Privacypolisymenu" className="subcategory">
                        Privacy Policy
                      </a>
                      <p className="ptag"></p>
                      <a href="/Termmenu" className="subcategory">
                        Terms & Conditions
                      </a>
                      <p className="ptag"></p>
                      <a href="/Privacypolisymenu" className="subcategory">
